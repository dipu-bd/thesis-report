...
\begin{figure} 
	\centering
	\includegraphics[scale=0.5]{./img/sample/stage0.jpg}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.5]{./img/sample/stage1.jpg}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.5]{./img/sample/stage2.jpg}
...
\begin{figure} 
	\centering
	\includegraphics[scale=0.5]{./img/sample/stage3.jpg}
...
\begin{figure} 
	\centering
	\includegraphics[scale=0.5]{./img/sample/stage4.jpg}
...
\begin{subfigure}{.5\textwidth}
  ...
  \caption{Gaussian blur on previous image}
...
\begin{subfigure}{.5\textwidth}
  ...
  \caption{A see-through view of the threshold with main image}
  \label{fig:GlassViewMixtureModel}
\end{subfigure}
\caption{Images found after applying mixture model.}
