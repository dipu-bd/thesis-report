...
\begin{figure} \label{fig:RescaledSample}
	\centering
	\includegraphics[scale=0.5]{./img/samples/stage0}
...
\end{equation}
\begin{figure} \label{fig:GraySample}
	\centering
	\includegraphics[scale=0.5]{./img/samples/stage1}
...
\begin{figure} \label{fig:SobelSample}
	\centering
	\includegraphics[scale=0.5]{./img/samples/stage2}
...
\begin{figure} \label{fig:GaussianSample}
	\centering
	\includegraphics[scale=0.5]{./img/samples/stage3}
...
\begin{figure} \label{fig:EnhanceSample}
	\centering
	\includegraphics[scale=0.5]{./img/samples/stage4}
