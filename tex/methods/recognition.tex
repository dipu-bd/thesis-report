...
\begin{figure}
\centering
%\includegraphics[width=0.5\linewidth]{./img/feature/hor}
...
\begin{figure}
\centering
%\includegraphics[width=0.5\linewidth]{./img/feature/ver}
...
\begin{figure}
\centering
%\includegraphics[width=0.5\linewidth]{./img/feature/fours}
\caption{Dividing image into upper and lower areas}
...
\begin{figure}
\centering
%\includegraphics[width=0.5\linewidth]{./img/feature/eights}
\caption{Dividing image into upper and lower areas}
